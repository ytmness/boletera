    ...
    <div className="min-h-screen regia-bg-main overflow-x-hidden">
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-end overflow-hidden bg-black">
        ...
        <header className="absolute top-0 left-0 right-0 z-50 px-3 sm:px-4 md:px-6 lg:px-12 py-2 sm:py-3 md:py-4 lg:py-6 lg:bg-transparent bg-regia-black/80 backdrop-blur-md border-b border-regia-gold-old/20 lg:border-0">
          ...
          {showMobileMenu && (
            <div className="lg:hidden absolute top-full left-0 right-0 mt-0 bg-regia-black/98 backdrop-blur-md border-b border-regia-gold-old/20 shadow-xl z-50">
          ...
          <div className="w-full hidden lg:flex items-center justify-between">
            ...
            {user ? (
              <button
                ...
                className="flex items-center gap-2 text-regia-cream/90 hover:text-regia-gold-bright transition-colors text-sm font-medium uppercase tracking-wider hover:scale-105"
                title="Cerrar Sesión"
              >
