...
# Script para solucionar PM2 y cargar variables de entorno correctamente
# Ejecutar en el servidor: bash scripts/solucionar-pm2-env.sh

set -e

echo "=========================================="
echo "🔧 SOLUCIONAR PM2 Y VARIABLES DE ENTORNO"
echo "=========================================="
