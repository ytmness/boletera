#!/bin/bash
# Comando FINAL para actualizar .env en el servidor con Session Pooler correcto
# Ejecutar en el servidor: bash COMANDO_FINAL_ENV_SERVIDOR.sh
...
# Escribir .env correcto (SESSION POOLER IPv4 - Puerto 5432)
cat > .env << 'ENVEOF'
# =========================
# SUPABASE PUBLIC
# =========================
...
# =========================
SUPABASE_SERVICE_ROLE_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imhsdmh1d3dhdG56cWl2aW9wcXJqIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNTQ2NDI1NywiZXhwIjoyMDUxMDQwMjU3fQ.lTXPRwm3XlsXDEF_zJVqZQm9OxXCOKQ8eTqZqD8U4

# =========================
# DATABASE (SESSION POOLER - IPv4, Puerto 5432)
# =========================
...
echo "✅ .env actualizado con Session Pooler correcto (Puerto 5432)"
echo ""
echo "📋 Verificación de URLs:"
grep -E '^(DATABASE_URL|DIRECT_URL)=' .env
echo ""
echo "🧪 Prueba de conexión a Supabase:"
